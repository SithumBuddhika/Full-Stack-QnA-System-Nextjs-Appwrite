...
//         <div className="flex items-center justify-center">
//           <div className="relative max-w-[32rem] overflow-hidden">
//             {/* ✅ keep iconSlugs exactly like this */}
//             <IconCloud iconSlugs={slugs} />
//           </div>
//         </div>
//       </div>
...
// ✅ IMPORTANT: render IconCloud ONLY on client (no SSR)
// This kills hydration mismatch even if IconCloud uses random IDs internally.
const IconCloud = dynamic(
  () => import("@/components/ui/icon-cloud").then((m) => m.IconCloud),
  {
    ssr: false,
    loading: () => null, // ✅ no grey placeholder box
  }
);

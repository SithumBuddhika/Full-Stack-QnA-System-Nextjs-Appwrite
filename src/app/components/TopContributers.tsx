...
// // src/app/components/TopContributors.tsx (or wherever it is)
// import { cn } from "@/lib/utils";
// import { AnimatedList } from "@/components/ui/animated-list";
// import { users } from "@/models/server/config";
// import { Models, Query } from "node-appwrite";
...
//     <figure
//       className={cn(
//         "relative mx-auto w-full transform cursor-pointer overflow-hidden rounded-2xl p-4",
//         "transition-all duration-200 ease-in-out hover:scale-[103%]",
...
//         <div className="flex flex-col overflow-hidden">
//           <figcaption className="flex items-center whitespace-pre text-lg font-medium text-white">
//             <span className="text-sm sm:text-lg">{user.name}</span>
...
//   return (
//     <div className="relative flex max-h-[400px] min-h-[400px] w-full max-w-[32rem] flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
//       <AnimatedList>
//         {topUsers.users.map((user) => (
//           <Notification user={user} key={user.$id} />
//         ))}

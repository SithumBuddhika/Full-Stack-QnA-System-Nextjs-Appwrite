...
//   const user = await users.get<UserPrefs>(p.userId);

//   // ✅ Appwrite avatars often return a string URL (not { href })
//   const avatarSrc = safeSrc(avatars.getInitials(user.name, 200, 200));

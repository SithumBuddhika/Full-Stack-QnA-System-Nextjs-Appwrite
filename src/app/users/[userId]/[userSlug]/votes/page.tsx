...
type SP = { page?: string; voteStatus?: "upvoted" | "downvoted" };
...
const Page = async ({
  ...
  const query = [
    Query.equal("votedById", p.userId),
    ...
    <div className="px-4">
      <div className="mb-4 flex justify-between">
        ...
        <ul className="flex gap-1">
          <li>
            <Link
              href={`/users/${p.userId}/${p.userSlug}/votes`}
          ...
          <li>
            <Link
              href={`/users/${p.userId}/${p.userSlug}/votes?voteStatus=upvoted`}
              className={`block w-full rounded-full px-3 py-0.5 duration-200 ${
          ...
          <li>
            <Link
              href={`/users/${p.userId}/${p.userSlug}/votes?voteStatus=downvoted`}
              className={`block w-full rounded-full px-3 py-0.5 duration-200 ${

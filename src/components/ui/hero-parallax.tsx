...
export type HeroProduct = {
  ...
  title: string;
  link: string;
  thumbnail: string; // ✅ must be string
};
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 h-full w-full rounded-2xl bg-black opacity-0 group-hover/product:opacity-80" />
